        ...
        <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-black py-20">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                    ...
                    <div className="relative overflow-hidden bg-white/5 backdrop-blur-[40px] border border-white/10 rounded-[40px] p-10 md:p-16 flex flex-col justify-between min-h-[400px] md:min-h-[500px]">
                    ...
                    <div className="flex flex-col gap-6 md:gap-8">
                        ...
                        <div className="group relative overflow-hidden bg-white/5 backdrop-blur-[40px] border border-white/10 rounded-[40px] p-10 md:p-12 flex items-center justify-between cursor-pointer transition-all hover:bg-white/10">
